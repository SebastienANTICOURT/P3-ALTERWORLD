class AbstractManager {
  ...
  findProduct() {
    return this.database.query(`SELECT products.id, products.name, products.image1, products.Prix, products.Creator_id, nature.name, nature.id, univers.name, univers.id
    FROM products
